...
<body>
    ...
    if (isset($_POST['login']) and !empty($_POST['login']) and ($_POST['login'] == 'Login')) {
        ...
        if ($error == 0) {
            ...
            echo "<h6>Login fail. Please enter a valid username and password.</h6>" . PHP_EOL;
        } else {
    ...
    <h2>
        ...
        <a href="/bnb/index.php">[Return to main page]</a>
    </h2>

    <form method="POST">
        <p>
            <label for="username">Username:</label>
            <input type="text" id="username" name="username" minlength="2" maxlength="32" required autocomplete="off">
        </p>
