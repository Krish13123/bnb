...
//make sure you ALWAYS use prepared queries when creating custom SQL like below
    ...
    <h2><a href='listcustomers.php'>[Return to the Customer listing]</a><a href='/bnb/'>[Return to the main page]</a>
    </h2>
    <?php
    ...
    <?php
        ...
        echo "<h2>No Customer found, possbily deleted!</h2>"; //suitable feedback
